...
Original file is located at
    https://colab.research.google.com/drive/1pb7XQcjD4zh15hPRmSiJmY0wlw3J35wQ
...
df = pd.read_csv('/content/drive/MyDrive/Project_Experiments/DeepLearning_LangChain/chain_data/Data.csv')
df.head()
...
product = "Translate your documents"  # could be anythinig here
chain.run(product)
...
"""# the company name (first chain) pass to the second cahin"""
...
chain.run("Tell me a fun fact about the parenting.")